...
<div class="container">																												<!-- Erstellen div und hinzufügen zur Klasse Container -->
		...
		<form action="" method="POST">																								<!-- Erstellen form + setzen des "action"-Attributes, zum senden der Daten an diese Datei + setzen des "method"-Attributes, zum festlegen der Übertragung -->
